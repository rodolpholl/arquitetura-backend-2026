...
public class RegistrarLancamentoCommandValidator : AbstractValidator<RegistrarLancamentoCommand>
{
    public RegistrarLancamentoCommandValidator()
    {
        ...
        RuleFor(x => x.Valor)
            ...
            .WithMessage("Valor máximo permitido é R$ 999.999.999.999,99.")
            ...
            .Must((model, v) => model.Modalidade == ModalidadeLancamento.Devolucao ||
                                model.Modalidade == ModalidadeLancamento.Suprimento ||
